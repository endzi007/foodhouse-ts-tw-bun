...
export default function Ketering(props: Props) {
    const { ref, inView, entry } = useInView({ threshold: 0.1 })
    return <section ref={ref} className={`w-full mx-auto dark:bg-gray-900 lg:py-12 lg:flex lg:justify-center `}>
        <div
            className={`container overflow-hidden bg-white dark:bg-gray-900 lg:mx-8 lg:flex lg:max-w-6xl lg:w-full lg:shadow-md lg:rounded-xl beforeAnimation ${inView && "animateChild"}`}>
            <div className="lg:w-1/2">
                <img loading="lazy" className="object-fill" src="/ketering.jpg" alt="ketering - restoran Foodhouse Berane" />
            </div>
